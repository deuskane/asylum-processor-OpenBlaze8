    ...
    then
      ...
      then
        case conv_integer(address_i) is
          ...
          when    8 => instruction_o <= "01"&x"8A00";
          ...
          when   17 => instruction_o <= "01"&x"8A01";
          ...
          when   26 => instruction_o <= "01"&x"8A0F";
          ...
          when   35 => instruction_o <= "01"&x"8A10";
          ...
          when   44 => instruction_o <= "01"&x"8AFF";
          ...
          when   53 => instruction_o <= "01"&x"8A5A";
          ...
          when   62 => instruction_o <= "01"&x"8A00";
