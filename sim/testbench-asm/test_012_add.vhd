    ...
    then
      ...
      then
        case conv_integer(address_i) is
          ...
          when    8 => instruction_o <= "01"&x"9A10";
          when    9 => instruction_o <= "11"&x"5C0B";
          when   10 => instruction_o <= "11"&x"4047";
          when   11 => instruction_o <= "11"&x"540D";
          when   12 => instruction_o <= "11"&x"4047";
          when   13 => instruction_o <= "01"&x"4AA5";
          when   14 => instruction_o <= "11"&x"5010";
          when   15 => instruction_o <= "11"&x"4047";
          when   16 => instruction_o <= "00"&x"1A00";
          when   17 => instruction_o <= "01"&x"9A20";
          when   18 => instruction_o <= "11"&x"5C14";
          when   19 => instruction_o <= "11"&x"4047";
          when   20 => instruction_o <= "11"&x"5416";
          when   21 => instruction_o <= "11"&x"4047";
          when   22 => instruction_o <= "01"&x"4AA6";
          when   23 => instruction_o <= "11"&x"5019";
          when   24 => instruction_o <= "11"&x"4047";
          when   25 => instruction_o <= "00"&x"1A00";
          when   26 => instruction_o <= "01"&x"9A30";
          when   27 => instruction_o <= "11"&x"5C1D";
          when   28 => instruction_o <= "11"&x"4047";
          when   29 => instruction_o <= "11"&x"541F";
          when   30 => instruction_o <= "11"&x"4047";
          when   31 => instruction_o <= "01"&x"4AB4";
          when   32 => instruction_o <= "11"&x"5022";
          when   33 => instruction_o <= "11"&x"4047";
          when   34 => instruction_o <= "00"&x"1A00";
          when   35 => instruction_o <= "01"&x"9A40";
          when   36 => instruction_o <= "11"&x"5C26";
          when   37 => instruction_o <= "11"&x"4047";
          when   38 => instruction_o <= "11"&x"5428";
          when   39 => instruction_o <= "11"&x"4047";
          when   40 => instruction_o <= "01"&x"4AB5";
          when   41 => instruction_o <= "11"&x"502B";
          when   42 => instruction_o <= "11"&x"4047";
          when   43 => instruction_o <= "00"&x"1A00";
          when   44 => instruction_o <= "01"&x"9A50";
          when   45 => instruction_o <= "11"&x"582F";
          when   46 => instruction_o <= "11"&x"4047";
          when   47 => instruction_o <= "11"&x"5431";
          when   48 => instruction_o <= "11"&x"4047";
          when   49 => instruction_o <= "01"&x"4AA4";
          when   50 => instruction_o <= "11"&x"5034";
          when   51 => instruction_o <= "11"&x"4047";
          when   52 => instruction_o <= "00"&x"1A00";
          when   53 => instruction_o <= "01"&x"9A60";
          when   54 => instruction_o <= "11"&x"5C38";
          when   55 => instruction_o <= "11"&x"4047";
          when   56 => instruction_o <= "11"&x"543A";
          when   57 => instruction_o <= "11"&x"4047";
          when   58 => instruction_o <= "01"&x"4AFF";
          when   59 => instruction_o <= "11"&x"503D";
          when   60 => instruction_o <= "11"&x"4047";
          when   61 => instruction_o <= "00"&x"1A10";
          when   62 => instruction_o <= "01"&x"9A10";
          when   63 => instruction_o <= "11"&x"5C41";
          when   64 => instruction_o <= "11"&x"4047";
          when   65 => instruction_o <= "11"&x"5043";
          when   66 => instruction_o <= "11"&x"4047";
          when   67 => instruction_o <= "01"&x"4A00";
          when   68 => instruction_o <= "11"&x"5046";
          when   69 => instruction_o <= "11"&x"4047";
          when   70 => instruction_o <= "11"&x"43FC";
          when   71 => instruction_o <= "00"&x"0EED";
          when   72 => instruction_o <= "10"&x"CEE0";
          when   73 => instruction_o <= "11"&x"4047";
