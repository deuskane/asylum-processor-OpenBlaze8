    ...
    then
      ...
      then
        case conv_integer(address_i) is
          when    0 => instruction_o <= "00"&x"003C";
          when    1 => instruction_o <= "00"&x"02FF";
          when    2 => instruction_o <= "00"&x"F200";
          when    3 => instruction_o <= "10"&x"C020";
          when    4 => instruction_o <= "00"&x"4100";
          when    5 => instruction_o <= "01"&x"5120";
          when    6 => instruction_o <= "11"&x"53FC";
          when    7 => instruction_o <= "00"&x"0EED";
          when    8 => instruction_o <= "10"&x"CEE0";
          when    9 => instruction_o <= "11"&x"4007";
