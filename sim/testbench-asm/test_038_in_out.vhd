    ...
    then
      ...
      then
        case conv_integer(address_i) is
          when    0 => instruction_o <= "00"&x"00FF";
          when    1 => instruction_o <= "10"&x"C020";
          when    2 => instruction_o <= "00"&x"4100";
          when    3 => instruction_o <= "00"&x"1200";
          when    4 => instruction_o <= "00"&x"E2FF";
          when    5 => instruction_o <= "01"&x"5120";
          when    6 => instruction_o <= "11"&x"540A";
          when    7 => instruction_o <= "01"&x"C001";
          when    8 => instruction_o <= "11"&x"5C01";
          when    9 => instruction_o <= "11"&x"43FC";
          when   10 => instruction_o <= "00"&x"0EED";
          when   11 => instruction_o <= "10"&x"CEE0";
          when   12 => instruction_o <= "11"&x"400A";
